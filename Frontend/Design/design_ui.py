...
"background-color: rgba(255, 255, 255, 0);")
        ...
        self.verticalLayout_24.addWidget(self.frame_23, 0, QtCore.Qt.AlignmentFlag.AlignTop)
        ...
        self.lineEdit_CreateQR = QtWidgets.QLineEdit(parent=self.frame_25)
        self.lineEdit_CreateQR.setObjectName("lineEdit_CreateQR")
        self.horizontalLayout_15.addWidget(self.lineEdit_CreateQR)
        self.pushButton_CreateQR = QtWidgets.QPushButton(parent=self.frame_25)
        self.pushButton_CreateQR.setObjectName("pushButton_CreateQR")
        self.horizontalLayout_15.addWidget(self.pushButton_CreateQR)
        self.verticalLayout_29.addWidget(self.frame_25, 0, QtCore.Qt.AlignmentFlag.AlignTop)
        self.pushButton_CreatedQRImage_Save = QtWidgets.QPushButton(parent=self.frame_24)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_CreatedQRImage_Save.sizePolicy().hasHeightForWidth())
        self.pushButton_CreatedQRImage_Save.setSizePolicy(sizePolicy)
        self.pushButton_CreatedQRImage_Save.setText("")
        self.pushButton_CreatedQRImage_Save.setObjectName("pushButton_CreatedQRImage_Save")
        self.verticalLayout_29.addWidget(self.pushButton_CreatedQRImage_Save)
        ...
        self.pushButton_KiemTraThietBi = QtWidgets.QPushButton(parent=self.frame_8)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_KiemTraThietBi.sizePolicy().hasHeightForWidth())
        self.pushButton_KiemTraThietBi.setSizePolicy(sizePolicy)
        self.pushButton_KiemTraThietBi.setObjectName("pushButton_KiemTraThietBi")
        self.horizontalLayout_3.addWidget(self.pushButton_KiemTraThietBi)
        ...
        self.label_14 = QtWidgets.QLabel(parent=self.frame_ToPageCreateQR)
...
"}")
        ...
        self.scrollAreaWidgetContents_Rooms.setGeometry(QtCore.QRect(0, 0, 570, 155))
        ...
        self.scrollAreaWidgetContents_RoomInfo.setGeometry(QtCore.QRect(0, 0, 570, 214))
        ...
        self.page_QR = QtWidgets.QWidget()
        self.page_QR.setObjectName("page_QR")
        self.verticalLayout_16 = QtWidgets.QVBoxLayout(self.page_QR)
        self.verticalLayout_16.setObjectName("verticalLayout_16")
        self.frame_19 = QtWidgets.QFrame(parent=self.page_QR)
        ...
        self.verticalLayout_17.addWidget(self.frame_20, 0, QtCore.Qt.AlignmentFlag.AlignTop)
        ...
        self.label_QRCode = QtWidgets.QLabel(parent=self.frame_21)
        font = QtGui.QFont()
        ...
        self.verticalLayout_19.addWidget(self.label_QRCode, 0, QtCore.Qt.AlignmentFlag.AlignHCenter|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.verticalLayout_17.addWidget(self.frame_21)
        self.verticalLayout_16.addWidget(self.frame_19)
        self.stackedWidget.addWidget(self.page_QR)
        ...
        self.scrollAreaWidgetContents_Test.setGeometry(QtCore.QRect(0, 0, 546, 226))
...
"T07.NVKH.2023.P7.03"))
        ...
        self.label_13.setText(_translate("MainWindow", "Nội dung:"))
        self.pushButton_CreateQR.setText(_translate("MainWindow", "Tạo"))
        ...
        self.pushButton_KiemTraThietBi.setText(_translate("MainWindow", "Kiểm tra thiết bị"))
        ...
        self.label_9.setText(_translate("MainWindow", "Quét mã QR"))
        self.label_QRCode.setText(_translate("MainWindow", "QR CODE HERE..."))
