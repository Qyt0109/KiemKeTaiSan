...
"background-color: rgba(255, 255, 255, 0);")
        ...
        self.label_CreatedQRImage = QtWidgets.QLabel(parent=self.frame_24)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_CreatedQRImage.sizePolicy().hasHeightForWidth())
        self.label_CreatedQRImage.setSizePolicy(sizePolicy)
        self.label_CreatedQRImage.setText("")
        self.label_CreatedQRImage.setScaledContents(True)
        self.label_CreatedQRImage.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.label_CreatedQRImage.setObjectName("label_CreatedQRImage")
        self.verticalLayout_29.addWidget(self.label_CreatedQRImage)
